...
int main(int argc, char **argv)
{
   ...
   */
   ...
   {
    pthread_create(&lt[i], NULL, (void *)&lizardThread, (void *)(intptr_t)i);
   }
...
void * lizardThread( void * param )
{
  int num = (int)(intptr_t)param; //the thread count that is being executed
  ...
  while(running)
    {
       ...
       */
       ...
       //cross sago->monkey grass
          //it takes up to CROSS_SECONDS to cross
       cross_sago_2_monkeyGrass(num);
       //eat the monkey grass
